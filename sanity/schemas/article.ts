...
export default defineType({
  ...
  groups: [
    ...
    { name: 'multisite', title: 'Multi-Site' }, { name: 'abcm', title: 'ABCM Metadata' },
    { name: 'links', title: 'Article Buttons' },
  ],
  fields: [
    ...
    defineField({ name: 'contentType', title: 'Content Type', type: 'string', group: 'content', options: { list: [{ title: 'Article', value: 'article' }, { title: 'Guide', value: 'guide' }, { title: 'Tutorial', value: 'tutorial' }, { title: 'News', value: 'news' }] } }),
