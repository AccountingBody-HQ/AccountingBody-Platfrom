    ...
    <div className="mt-10 pt-10 border-t border-slate-200">
      ...
      {submitted && (
        <div className="mt-8 flex flex-col sm:flex-row items-stretch gap-3">
          <button onClick={handleRetry} className="flex-1 h-14 px-7 rounded-lg text-base font-semibold bg-gold-500 text-navy-950 hover:bg-gold-400 transition-colors flex items-center justify-center">
            Try a new set
          </button>
          <a href="/practice-questions" className="flex-1 h-14 px-7 rounded-lg text-base font-semibold border border-slate-300 text-navy-950 hover:border-navy-950 transition-colors flex items-center justify-center">
