...
const components: PortableTextComponents = {
  ...
  list: {
    ...
    number: ({ children }) => <ol style={{listStyleType:"decimal",paddingLeft:"1.5rem",marginBottom:"1.25rem"}} className="space-y-2">{children}</ol>,
  },
  listItem: {
    bullet: ({ children }) => (
    ...
    number: ({ children }) => <li style={{display:"list-item",listStyleType:"decimal"}} className="text-slate-700 text-base leading-relaxed pl-1">{children}</li>,
  },
  marks: {
