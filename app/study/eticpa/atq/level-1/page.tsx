...
const MODULES = [
  {
    ...
    description: 'The accounting equation, double-entry bookkeeping, the trial balance, financial statements and accounting concepts.',
    topics: 5,
  ...
  },
  {
    ...
    description: 'Cost classification, costing methods, job and batch costing, marginal vs absorption costing and CVP analysis.',
    topics: 5,
  ...
  },
  {
    ...
    description: 'Professional communication, workplace competencies, IT in finance, ethics and personal effectiveness.',
    topics: 5,
  ...
  },
  {
    ...
    description: 'Ethiopian commercial law, contract law, business organisations, employment law and regulatory framework.',
    topics: 5,
    href: '/study/eticpa/atq/level-1/ethiopian-business-law',
  },
]

export default async function ATQLevel1Page() {
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-3 mb-6">
              <span className="text-xs font-bold px-3 py-1.5 rounded-md" style={{ backgroundColor: '#C9982A', color: '#1A4731' }}>
                ATQ — Accounting Technician Qualification
              </span>
            </div>
            ...
            <p className="text-white/70 text-xl leading-relaxed max-w-2xl mb-10">
              The entry point into Ethiopian professional accountancy. Four modules covering the core financial, legal and professional knowledge needed to work in any accounting environment.
            </p>
      ...
      <section id="modules" className="section bg-slate-50 border-t border-slate-100">
        <div className="container-site">
          <div className="max-w-2xl mb-12">
            <span className="eyebrow mb-3 block" style={{ color: '#1A4731' }}>Level 1 Modules</span>
            <h2 className="section-title mb-4">Four modules. Solid foundations.</h2>
