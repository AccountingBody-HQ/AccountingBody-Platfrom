          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                Business Skills is the third module of ATQ Level 1. It focuses on the professional and interpersonal competencies that complement technical accounting knowledge — the skills employers consistently rate as critical for finance professionals.
              </p>
