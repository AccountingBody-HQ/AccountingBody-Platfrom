...
const MODULE = {
  ...
  description: 'Develop the professional competencies that every finance professional needs to succeed in the modern workplace. This module covers communication, workplace effectiveness, IT in finance, ethics and personal development — the skills that turn technical knowledge into professional excellence.',
  outcomes: [
    'Communicate effectively in a professional finance environment',
    'Demonstrate workplace competencies expected of a finance technician',
    'Use IT tools effectively to support finance functions',
    'Apply ethical principles and professional behaviour in the workplace',
    'Manage personal effectiveness and continuous professional development',
  ],
  topics: [
    { name: 'Professional Communication', slug: 'professional-communication' },
    { name: 'Workplace Competencies', slug: 'workplace-competencies' },
    { name: 'IT in Finance', slug: 'it-in-finance' },
    { name: 'Ethics & Professional Behaviour', slug: 'ethics-and-professional-behaviour' },
    { name: 'Personal Effectiveness', slug: 'personal-effectiveness' },
  ],
  prevModule: {
...
export default async function BusinessSkillsPage() {
      ...
      <section className="relative overflow-hidden py-20 md:py-28" style={{ backgroundColor: '#1A4731' }}>
        ...
        <div className="container-site relative z-10">
          <nav className="flex items-center gap-2 text-white/40 text-sm mb-8 flex-wrap">
            ...
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeWidth="2" d="M9 5l7 7-7 7" /></svg>
            <span className="text-white/70">Business Skills</span>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                Business Skills is the third module of <span translate="no">ATQ Level 1</span>. It focuses on the professional and interpersonal competencies that complement technical accounting knowledge — the skills employers consistently rate as critical for finance professionals.
              </p>
            ...
            <div className="rounded-2xl p-8 border" style={{ backgroundColor: '#f0f7f4', borderColor: '#d1e8db' }}>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { label: 'Module', value: 'Business Skills' },
        ...
        <div className="container-site">
          <div className="max-w-2xl mb-12">
            ...
            <p className="text-slate-500 text-lg leading-relaxed">
              Five core topics make up Business Skills. Study notes are published for each topic as they are completed.
            </p>
          </div>
        ...
        <div className="container-site">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-12">
            <div className="max-w-2xl">
              ...
              <h2 className="section-title mb-4">Business Skills notes</h2>
              <p className="text-slate-500 text-lg leading-relaxed">
