          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                Introduction to Accounting is the foundation module of <span translate="no">ATQ Level 1</span>. It establishes the core principles that every accounting professional must master before progressing to more advanced study.
              </p>
      ...
      <section id="mock-exam" className="section border-t border-slate-100" style={{ backgroundColor: '#1A4731' }}>
        <div className="container-site">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-white/40 text-xs mt-4 text-center mx-auto">More questions are added automatically as new practice sets are published.</p>
          </div>
        </div>
      </section>
