...
const MODULE = {
  ...
  outcomes: [
    ...
    'Apply job costing and batch costing methods to practical scenarios',
    ...
    'Prepare and interpret cost statements for management use',
  ],
  topics: [
    { name: 'Cost Classification', slug: 'cost-classification' },
    { name: 'Costing Methods', slug: 'costing-methods' },
    { name: 'Job & Batch Costing', slug: 'job-and-batch-costing' },
    { name: 'Marginal vs Absorption Costing', slug: 'marginal-vs-absorption-costing' },
    { name: 'Cost-Volume-Profit Analysis', slug: 'cost-volume-profit-analysis' },
  ],
  prevModule: {
        ...
        <div className="container-site">
          <div className="max-w-2xl mb-12">
            ...
            <p className="text-slate-500 text-lg leading-relaxed">
              Five core topics make up Cost Accounting. Study notes are published for each topic as they are completed.
            </p>
          </div>
        ...
        <div className="container-site">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-12">
            <div className="max-w-2xl">
              ...
              <h2 className="section-title mb-4">Cost Accounting notes</h2>
              <p className="text-slate-500 text-lg leading-relaxed">
