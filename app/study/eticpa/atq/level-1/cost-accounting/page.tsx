      ...
      <section className="relative overflow-hidden py-20 md:py-28" style={{ backgroundColor: '#1A4731' }}>
        ...
        <div className="container-site relative z-10">
          <nav className="flex items-center gap-2 text-white/40 text-sm mb-8 flex-wrap">
            ...
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeWidth="2" d="M9 5l7 7-7 7" /></svg>
            <Link href="/study/eticpa/atq/level-1" className="hover:text-white/70 transition-colors"><span translate="no"><span translate="no">ATQ Level 1</span></span></Link>
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeWidth="2" d="M9 5l7 7-7 7" /></svg>
            <span className="text-white/70">Cost Accounting</span>
          </nav>
          <div className="max-w-3xl">
            <div className="flex items-center gap-3 mb-6">
              <span className="text-xs font-bold px-3 py-1.5 rounded-md" style={{ backgroundColor: '#C9982A', color: '#1A4731' }}><span translate="no">ATQ Level 1</span></span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                Cost Accounting is the second module of <span translate="no">ATQ Level 1</span>. It equips you with the tools to understand how costs behave, how they are recorded, and how cost data drives strategic decisions in any business environment.
              </p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-12">
              <div className="max-w-2xl">
                ...
                <p className="text-slate-500 text-lg leading-relaxed">
                  {course.chapters.length} units · {course.chapters.reduce((acc, ch) => acc + ch.lessons.length, 0)} chapters · {totalArticles} study notes — structured as a progressive course from cost foundations to variance analysis.
                </p>
              </div>
              <Link href={`/free-courses/${COURSE_SLUG}`}
      ...
      <section id="mock-exam" className="section border-t border-slate-100" style={{ backgroundColor: '#1A4731' }}>
        <div className="container-site">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-white/40 text-xs mt-4 text-center mx-auto">Questions are added automatically as new practice sets are published.</p>
          </div>
        </div>
      </section>
