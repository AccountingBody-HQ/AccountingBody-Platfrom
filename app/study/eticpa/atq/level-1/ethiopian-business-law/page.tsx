...
const MODULE = {
  level: 'level-1',
  levelLabel: 'Level 1 — Foundation Technician',
  slug: 'ethiopian-business-law',
  name: 'Ethiopian Business Law',
  description: 'Understand the legal framework that governs business and finance in Ethiopia. This module covers Ethiopian commercial law, contract law, business organisations, employment law and the regulatory environment — essential knowledge for any finance professional operating in or with Ethiopia.',
  outcomes: [
    'Explain the key principles of Ethiopian commercial law and their application to business',
    'Identify the essential elements of a valid contract under Ethiopian law',
    'Distinguish between different forms of business organisation in Ethiopia',
    'Apply Ethiopian employment law principles to workplace scenarios',
    'Navigate the regulatory framework governing financial practice in Ethiopia',
  ],
  topics: [
    { name: 'Ethiopian Commercial Law', slug: 'ethiopian-commercial-law' },
    { name: 'Contract Law', slug: 'contract-law' },
    { name: 'Business Organisations', slug: 'business-organisations' },
    { name: 'Employment Law', slug: 'employment-law' },
    { name: 'Regulatory Framework', slug: 'regulatory-framework' },
  ],
  prevModule: {
      ...
      <div className="p-6 flex flex-col flex-1">
        <div className="flex items-center justify-between mb-4">
          <span className="text-xs font-bold px-2.5 py-1 rounded-md bg-[#f0f7f4] text-[#1A4731]">
            <span translate="no">ATQ Level 1</span>
          </span>
          {article.read_time && (
...
export default async function EthiopianBusinessLawPage() {
      ...
      <section className="relative overflow-hidden py-20 md:py-28" style={{ backgroundColor: '#1A4731' }}>
        ...
        <div className="container-site relative z-10">
          <nav className="flex items-center gap-2 text-white/40 text-sm mb-8 flex-wrap">
            ...
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeWidth="2" d="M9 5l7 7-7 7" /></svg>
            <Link href="/study/eticpa/atq/level-1" className="hover:text-white/70 transition-colors"><span translate="no">ATQ Level 1</span></Link>
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeWidth="2" d="M9 5l7 7-7 7" /></svg>
            <span className="text-white/70">Ethiopian Business Law</span>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                Ethiopian Business Law is the fourth and final module of <span translate="no">ATQ Level 1</span>. It provides the legal grounding that every finance professional needs to operate confidently and compliantly within the Ethiopian business environment.
              </p>
            ...
            <div className="rounded-2xl p-8 border" style={{ backgroundColor: '#f0f7f4', borderColor: '#d1e8db' }}>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { label: 'Module', value: 'Ethiopian Business Law' },
        ...
        <div className="container-site">
          <div className="max-w-2xl mb-12">
            ...
            <p className="text-slate-500 text-lg leading-relaxed">
              Five core topics make up Ethiopian Business Law. Study notes are published for each topic as they are completed.
            </p>
          </div>
        ...
        <div className="container-site">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-12">
            <div className="max-w-2xl">
              ...
              <h2 className="section-title mb-4">Ethiopian Business Law notes</h2>
              <p className="text-slate-500 text-lg leading-relaxed">
