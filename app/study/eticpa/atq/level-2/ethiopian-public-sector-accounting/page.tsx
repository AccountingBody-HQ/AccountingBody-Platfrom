          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                Ethiopian Public Sector Accounting is the fifth and final module of ATQ Level 2. It provides specialist knowledge of government finance — covering the unique standards, frameworks and accountability requirements that govern public sector financial management in Ethiopia.
              </p>
