...
const MODULE = {
  ...
  outcomes: [
    ...
    'Apply government accounting standards to public sector financial reporting',
    'Account for budget execution and produce public sector financial reports',
    'Describe the role and scope of public sector audit in Ethiopia',
    'Apply accountability and transparency principles to public sector finance',
  ],
  topics: [
    { name: 'Public Financial Management', slug: 'public-financial-management' },
    { name: 'Government Accounting Standards', slug: 'government-accounting-standards' },
    { name: 'Budget Execution & Reporting', slug: 'budget-execution-and-reporting' },
    { name: 'Public Sector Audit', slug: 'public-sector-audit' },
    { name: 'Accountability & Transparency', slug: 'accountability-and-transparency' },
  ],
  prevModule: {
...
export default async function EthiopianPublicSectorAccountingPage() {
      ...
      <section className="relative overflow-hidden py-20 md:py-28" style={{ backgroundColor: '#1A4731' }}>
        ...
        <div className="container-site relative z-10">
          <nav className="flex items-center gap-2 text-white/40 text-sm mb-8 flex-wrap">
            ...
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeWidth="2" d="M9 5l7 7-7 7" /></svg>
            <span className="text-white/70">Ethiopian Public Sector Accounting</span>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                Ethiopian Public Sector Accounting is the fifth and final module of <span translate="no">ATQ Level 2</span>. It provides specialist knowledge of government finance — covering the unique standards, frameworks and accountability requirements that govern public sector financial management in Ethiopia.
              </p>
            ...
            <div className="rounded-2xl p-8 border" style={{ backgroundColor: '#f0f7f4', borderColor: '#d1e8db' }}>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { label: 'Module', value: 'Ethiopian Public Sector Accounting' },
        ...
        <div className="container-site">
          <div className="max-w-2xl mb-12">
            ...
            <p className="text-slate-500 text-lg leading-relaxed">
              Five core topics make up Ethiopian Public Sector Accounting. Study notes are published for each topic as they are completed.
            </p>
          </div>
        ...
        <div className="container-site">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-12">
            <div className="max-w-2xl">
              ...
              <h2 className="section-title mb-4">Ethiopian Public Sector Accounting notes</h2>
              <p className="text-slate-500 text-lg leading-relaxed">
