...
export default async function AssuranceControlsEthicsMockExamPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="bg-white border-b border-slate-200">
        <div className="container-site py-4">
          <nav className="flex items-center gap-2 text-xs text-slate-400 flex-wrap">
            ...
            <span>/</span>
            <a href="/study/eticpa/atq/level-2/assurance-controls-ethics" className="hover:text-slate-600 transition-colors">Assurance, Controls & Ethics</a>
            <span>/</span>
      ...
      <div className="container-site py-10 md:py-16">
        <MockExamClient
          level="level-2"
          module="assurance-controls-ethics"
          moduleName="Assurance, Controls & Ethics"
          backHref="/study/eticpa/atq/level-2/assurance-controls-ethics"
        />
      </div>
    </div>
  )
