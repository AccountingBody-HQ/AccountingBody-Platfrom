...
const MODULE = {
  ...
  description: 'Develop advanced financial reporting skills under Ethiopian GAAP. This module builds your ability to prepare and interpret complete financial statements, apply accounting standards, and produce consolidated and company accounts — preparing you for senior technician roles in any Ethiopian organisation.',
  outcomes: [
    'Prepare financial statements under Ethiopian GAAP and applicable accounting standards',
    'Account for company transactions including share capital, dividends and reserves',
    'Produce consolidated financial statements for group entities',
    'Apply financial reporting and disclosure requirements to practical scenarios',
    'Interpret financial statements to assess the performance and position of an organisation',
  ],
  topics: [
    { name: 'Financial Statements under Ethiopian GAAP', slug: 'financial-statements-ethiopian-gaap' },
    { name: 'Accounting Standards', slug: 'accounting-standards' },
    { name: 'Company Accounts', slug: 'company-accounts' },
    { name: 'Consolidated Statements', slug: 'consolidated-statements' },
    { name: 'Financial Reporting & Disclosure', slug: 'financial-reporting-and-disclosure' },
  ],
  prevModule: {
    name: 'ATQ Level 1',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                Financial Accounting is the first module of ATQ Level 2. It advances your technical reporting skills beyond the foundations of Level 1 — covering the full preparation of financial statements, accounting standards and consolidated group accounts.
              </p>
        ...
        <div className="container-site">
          <div className="max-w-2xl mb-12">
            ...
            <p className="text-slate-500 text-lg leading-relaxed">
              Five core topics make up Financial Accounting. Study notes are published for each topic as they are completed.
            </p>
          </div>
        ...
        <div className="container-site">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-12">
            <div className="max-w-2xl">
              ...
              <h2 className="section-title mb-4">Financial Accounting notes</h2>
              <p className="text-slate-500 text-lg leading-relaxed">
