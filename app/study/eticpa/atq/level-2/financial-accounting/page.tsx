...
const MODULE = {
  ...
  description: 'Develop advanced financial reporting skills under IFRS. Prepare and interpret complete financial statements, apply accounting standards, and produce consolidated group accounts — preparing you for senior technician roles in any Ethiopian organisation.',
  outcomes: [
    'Prepare financial statements under IFRS and applicable accounting standards',
          ...
          <div className="container-site">
            <div className="max-w-2xl mb-12">
              ...
              <p className="text-slate-500 text-lg leading-relaxed">
                The course is structured into {course.chapters.length} units covering the full Financial Accounting syllabus.
              </p>
            </div>
            <div className="space-y-4">
        ...
        <div className="container-site">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-white/70 text-lg leading-relaxed mb-10">
              Practice with real exam-style questions drawn from the full Financial Accounting question pool.
            </p>
            ...
            <Link href="/study/eticpa/atq/level-2/financial-accounting/mock-exam"
              className="inline-flex items-center justify-center gap-2 rounded-lg text-sm font-semibold transition-colors"
              style={{ backgroundColor: '#C9982A', color: '#1A4731', height: '48px', width: '220px', boxSizing: 'border-box' }}>
              Start Mock Exam
            </Link>
