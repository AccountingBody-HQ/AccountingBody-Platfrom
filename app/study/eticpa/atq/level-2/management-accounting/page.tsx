...
const MODULE = {
  ...
  description: 'Master the tools that drive business performance. Prepare budgets, analyse variances, measure performance and produce management reports that support strategic decision-making in Ethiopian organisations.',
  outcomes: [
    'Prepare budgets and forecasts for planning and control purposes',
    'Calculate and interpret variances to support performance management',
    'Apply performance measurement frameworks to assess organisational effectiveness',
    'Use management accounting information to support business decision-making',
    'Prepare management reports that communicate financial information clearly',
  ],
  prevModule: { name: 'Financial Accounting', href: '/study/eticpa/atq/level-2/financial-accounting' },
  nextModule: { name: 'Assurance, Controls & Ethics', href: '/study/eticpa/atq/level-2/assurance-controls-ethics' },
}

const COURSE_SLUG = 'eticpa-atq-level-2-management-accounting'
const totalQuestions = 437

export default async function ManagementAccountingPage() {
      ...
      <section className="relative overflow-hidden py-20 md:py-28" style={{ backgroundColor: '#1A4731' }}>
        ...
        <div className="container-site relative z-10">
          <nav className="flex items-center gap-2 text-white/40 text-sm mb-8 flex-wrap">
            ...
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeWidth="2" d="M9 5l7 7-7 7" /></svg>
            <span className="text-white/70">Management Accounting</span>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                Management Accounting is the second module of ATQ Level 2. It focuses on the internal use of financial information — giving you the tools to plan, control and improve organisational performance through budgeting, analysis and reporting.
              </p>
            ...
            <div className="rounded-2xl p-8 border" style={{ backgroundColor: '#f0f7f4', borderColor: '#d1e8db' }}>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { label: 'Module', value: 'Management Accounting' },
          ...
          <div className="container-site">
            <div className="max-w-2xl mb-12">
              ...
              <p className="text-slate-500 text-lg leading-relaxed">
                The course is structured into {course.chapters.length} units covering the full Management Accounting syllabus.
              </p>
            </div>
            <div className="space-y-4">
        ...
        <div className="container-site">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-white/70 text-lg leading-relaxed mb-10">
              Practice with real exam-style questions drawn from the full Management Accounting question pool.
            </p>
            ...
            <Link href="/study/eticpa/atq/level-2/management-accounting/mock-exam"
              className="inline-flex items-center justify-center gap-2 rounded-lg text-sm font-semibold transition-colors"
              style={{ backgroundColor: '#C9982A', color: '#1A4731', height: '48px', width: '220px', boxSizing: 'border-box' }}>
              Start Mock Exam
            </Link>
