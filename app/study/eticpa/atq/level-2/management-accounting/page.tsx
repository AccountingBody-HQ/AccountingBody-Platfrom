...
const MODULE = {
  ...
  description: 'Master the tools that drive business performance. This module develops your ability to prepare budgets, analyse variances, measure performance and produce management reports that support strategic decision-making in Ethiopian organisations.',
  outcomes: [
  ...
  topics: [
    { name: 'Budgeting & Forecasting', slug: 'budgeting-and-forecasting' },
    { name: 'Variance Analysis', slug: 'variance-analysis' },
    { name: 'Performance Measurement', slug: 'performance-measurement' },
        ...
        <div className="container-site">
          <div className="max-w-2xl mb-12">
            ...
            <p className="text-slate-500 text-lg leading-relaxed">
              Five core topics make up Management Accounting. Study notes are published for each topic as they are completed.
            </p>
          </div>
        ...
        <div className="container-site">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-12">
            <div className="max-w-2xl">
              ...
              <h2 className="section-title mb-4">Management Accounting notes</h2>
              <p className="text-slate-500 text-lg leading-relaxed">
