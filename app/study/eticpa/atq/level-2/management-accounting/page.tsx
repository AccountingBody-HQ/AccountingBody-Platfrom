          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                Management Accounting is the second module of <span translate="no">ATQ Level 2</span>. It focuses on the internal use of financial information — giving you the tools to plan, control and improve organisational performance through budgeting, analysis and reporting.
              </p>
