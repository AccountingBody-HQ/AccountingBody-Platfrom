      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {visible.map(btn => (
          ...
          >
            ...
            <svg
              className="w-4 h-4 text-slate-300 group-hover:text-slate-500 group-hover:translate-x-0.5 transition-all ml-auto shrink-0"
      ...
      <div className="flex items-start gap-4">
        <div className="w-12 h-12 rounded-full shrink-0 overflow-hidden bg-navy-200 flex items-center justify-center">
          {image?.asset?.url ? (
            ...
            <span className="font-display text-lg text-navy-700 font-bold">
      ...
      <section className="relative overflow-hidden bg-navy-950 py-14 md:py-20">
        ...
        <div className="container-site relative z-10">
          <nav className="flex items-center gap-2 text-white/40 text-sm mb-8 flex-wrap">
            ...
            <Link href={`/study/${params.category}`} className="hover:text-white/70 transition-colors capitalize">
                ...
                <div className="mb-8 flex items-start gap-3 p-4 rounded-xl bg-amber-50 border border-amber-200">
                  ...
                  <p className="text-sm text-amber-800 leading-relaxed">
                    The original version of this article is published on{' '}
                      ...
                      rel="noopener noreferrer"
                    >
                      {article.canonicalOwner === 'globalpayrollexpert'
                        ? 'GlobalPayrollExpert.com'
                        : article.canonicalOwner === 'ethiotax'
                        ? 'EthioTax.com'
                        : canonicalUrl!}
                    </a>.
                  </p>
