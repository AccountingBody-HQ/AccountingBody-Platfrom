              ...
              {'ABCDEFGHIJKLMNOPQRSTUVWXYZ'.split('').map(l => {
                ...
                return (
                    ...
                    className={[
                      ...
                      active ? 'bg-navy-50 text-navy-700 hover:bg-navy-950 hover:text-white cursor-pointer' : 'text-slate-300 cursor-default',
                    ].join(' ')}
                  >
                    {l}
                  </a>
                        ...
                        <div key={article._id} className="group flex items-start justify-between gap-4 px-5 py-4 hover:bg-slate-50 transition-colors">
                          <div className="flex items-start gap-3 min-w-0">
                            ...
                            <div className="min-w-0">
                              ...
                              {article.excerpt && (
                                <p className="text-xs text-slate-500 mt-0.5 line-clamp-1 leading-relaxed">{article.excerpt}</p>
                              )}
                            </div>
                          </div>
                          <div className="flex items-center gap-4 shrink-0 text-xs text-slate-400">
                            ...
                            <svg className="w-4 h-4 text-slate-300 group-hover:text-navy-400 group-hover:translate-x-0.5 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                            </svg>
                          </div>
                        </div>
