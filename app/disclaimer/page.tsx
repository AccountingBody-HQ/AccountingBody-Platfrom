  ...
  const sections = [
    ...
    },
    {
      ...
      body: [
        ...
        `Always cross-reference with the official published syllabus. ${platformName} is not affiliated with, endorsed by, or officially connected to any professional accounting body.`,
      ],
    },
    {
