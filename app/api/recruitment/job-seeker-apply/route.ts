...
export async function POST(req: NextRequest) {
  try {
    ...
    await resend.emails.send({
      ...
      to:      body.email.trim(),
      subject: `Verify your email — ${platformName} Job Seeker Registration`,
