    ...
    <main className="min-h-screen bg-surface">
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto text-center py-24">
          ...
          <h2 className="text-2xl font-bold text-navy-950 mb-3">Job Board Launching Soon</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/hire-talent/post-a-job" className="inline-block bg-navy-950 text-white font-semibold px-8 h-11 px-6 rounded-lg flex items-center justify-center hover:bg-navy-900 transition-colors">Post a Job →</Link>
            <Link href="/hire-talent" className="inline-block border border-navy-950 text-navy-950 font-semibold px-8 h-11 px-6 rounded-lg flex items-center justify-center hover:bg-navy-950 hover:text-white transition-colors">Learn More</Link>
          </div>
        </div>
      </section>
    </main>
