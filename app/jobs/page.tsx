          ...
          <div className="max-w-3xl mb-12">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link href="/jobs/find-work"
                className="flex-1 inline-flex items-center justify-center gap-2 h-14 px-7 rounded-xl text-sm font-semibold transition-opacity hover:opacity-90"
              ...
              <Link href="/jobs/hire-talent"
                className="flex-1 inline-flex items-center justify-center gap-2 h-14 px-7 rounded-xl text-sm font-medium text-white border border-white/25 hover:bg-white/10 transition-colors">
