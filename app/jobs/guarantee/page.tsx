...
export default async function GuaranteePage() {
  ...
  const contactEmail = isEthioTax ? 'info@ethiotax.com' : 'info@accountingbody.com'
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8">
            ...
            <ul className="space-y-3">
              {[
                ...
                `The guarantee applies to all permanent placements made by ${platformName}.`,
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8">
            ...
            <ul className="space-y-3">
              {[
                ...
                'Redundancy situations not related to candidate performance or suitability.',
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8">
            ...
            <p className="text-slate-500 leading-relaxed mb-4">
              If a placement does not work out within the guarantee period, contact us at{' '}
              <a href={`mailto:${contactEmail}`} className="text-navy-700 underline hover:text-gold-600">{contactEmail}</a>{' '}
              with the placement details. We will respond within 2 working days and initiate the replacement search process.
            </p>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/jobs/hire-talent"
                className="flex-1 text-center font-semibold h-11 flex items-center justify-center px-6 rounded-lg text-white transition-colors hover:opacity-90"
                style={{ background: brand }}>
                Submit a Hiring Brief
              </Link>
              <Link href="/jobs/find-work"
                className="flex-1 text-center font-semibold h-11 flex items-center justify-center px-6 rounded-lg transition-colors hover:opacity-80 border-2"
                style={{ background: '#fff', color: brand, borderColor: brand }}>
