        ...
        <div className="container-site relative z-10">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
              <a href="#services"
                className="sm:flex-1 inline-flex items-center justify-center gap-2 h-13 px-7 text-sm font-semibold rounded-lg bg-gold-500 text-navy-950 hover:bg-gold-400 transition-colors shadow-gold">
                View Our Services
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
              </a>
              <a href="/firms-freelancers/join"
                className="sm:flex-1 inline-flex items-center justify-center gap-2 h-13 px-7 text-sm font-semibold rounded-lg border border-white/20 text-white/80 hover:bg-white/10 transition-colors">
                Join Our Network
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
            <div className="max-w-xl">
              ...
              <h2 className="font-display leading-[1.06] mb-4"
                ...
                Also need to hire payroll<br />
                <span style={{ opacity: 0.7 }}>or finance specialists?</span>
              </h2>
            ...
            <div className="rounded-2xl overflow-hidden shrink-0 w-full lg:w-[380px]"
              ...
              <div className="grid grid-cols-2">
                {[
                  ...
                  { value: 'Finance', label: 'Specialists only', sub: 'Payroll, tax, audit & more' },
                ].map((stat, i) => (
